...
| `docs/values.md` | **Values** on ordinary **`/h/`** / **`/w/`** (default reading): need inventory; **`x`+a/e/o/u** stake (*satisfies* / *rather* / *instead* / *detracts*); endings = **contact channel** (physical / mental / social / spiritual) on met stakes or **changeability** on **`xu`**; linked from the language reference. |
