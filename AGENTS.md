...
| `docs/coordination.md` | Word-, NP-, and AP-level coordinators (**al** / **am** / …; **zam** / **dal** / …; **gam** / …; Oxford style); clause-level `/x/` + same vowels; **-l**/**-m**/**-n** = closed/open/named, or exception/replacement on **e**; linked from the language reference. |
