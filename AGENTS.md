...
| `docs/quotations.md` | Span fences (writing PoS + `[…]` / `{…}` / `(…)` / `<…>` + **`~`** = paraphrase; open `{PoS}{TYPE}x{EDGE}{ENDING}` — e.g. `daxal` / `daxan` / `daxar`; TYPE **a** quote / **e** aside / **o** mention / **u** opaque; EDGE **a** multi / **e** clause-scoped / **u** empty; escape **`xoxol`**; **-l** exact / **-m** paraphrase / **-n** atomic / **-r** span anaphor; close **`xuxul`** / **`xuxum`**; linked from the language reference).
