...
| `docs/numbers.md` | Numeral grammar, including [digitless / zero-group forms](docs/numbers.md#zero-digit-groups) (`g+l` = plural count `>1`, …), [percent denominators](docs/numbers.md#percent-denominators) (whole NP + `/ɡ/` `…jo`), [ranges](docs/numbers.md#ranges) (SHARED continuum `/ɡ/` + two number endpoints; bare `zel z+3l z+5l` = preference), [extremum × digitless](docs/numbers.md#extremum-digitless) (focus ranked digitless → +∞ / −∞ / last place / unranked / …; `/v/` `/h/` without-bound overlays) and [measure phrases](docs/numbers.md#measure-phrases) (linked from the language reference). |
