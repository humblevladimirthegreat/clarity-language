...
| `docs/coordination.md` | Word-/phrase-level (Oxford: **al**, **zam**, **gam**, …); VP-level (`/v/`: **vam** / **var**, opener/`-r`); clause-level `/x/`; **-l**/**-m**/**-n** = closed/open/named or soft, or exception/replacement on **e**; linked from the language reference. |
