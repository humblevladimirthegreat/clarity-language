...
| `docs/values.md` | **Values** on ordinary **`/h/`** / **`/w/`** (default reading): need inventory; **`x`+a/e/o/u** stake (*satisfies* / *rather* / *instead* / *detracts*); endings = changeability; linked from the language reference. |
