...
| `docs/quotations.md` | Quote / mention / aside fences (writing PoS + `[…]` / `{…}` / `(…)` + **`~`** = paraphrase; speech `{PoS}{TYPE}x{EDGE}{ENDING}` — e.g. `daxal`; TYPE **a** quote / **e** aside / **o** mention; EDGE **a** open / **u** close; **-l** exact / **-m** paraphrase; no **-n**; linked from the language reference).
