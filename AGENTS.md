...
| `docs/coordination.md` | Phrase-level left fence (**zam**, **gam**, …; shared mods right after fence); left-open opener/`-r` for VP (`/v/`: **vam** / **var**) and clause (`/x/`); prefix-less **al**/**am**/**an**/**el**/… (**-l**/**-m**/named **-n** required) = in-clause revision (*including* / *rather* / *instead* / *except*; closed/open B-side or named frame); no bare word-level coordinators; **-l**/**-m**/**-n** = closed/open/named or soft; **e** = priority ranking; linked from the language reference. |
