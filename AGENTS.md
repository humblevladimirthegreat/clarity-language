...
| `docs/coordination.md` | Word-/phrase-level (Oxford: **al**, **zam**, **gam**, …); shared opener/`-r` for VP (`/v/`: **vam** / **var**) and clause (`/x/`); **-l**/**-m**/**-n** = closed/open/named or soft, or exception/replacement on **e**; linked from the language reference. |
