...
| `docs/plurality.md` | Plural grammar (**-sh** = group referent on nouns / event-sets / vocatives; **collective** on `/ɡ/`; unused on `/w/` `/h/` `/x/` and number words; generics / *every K* via joins, not **-sh** — [universals](docs/coordination.md#universals-domains-generics); linked from the language reference). |
...
| `docs/coordination.md` | **Joins** / **revisers** / **restrictors**; phrase-, VP-, clause-level **fence**; **set joins** vs **rank joins**; arity **bare** / **focus** / **list**; **`/h/`** / **`/w/`** restrictors (**hal**, **hual**, …); **-r** member; revisers **al**/**am**/…; linked from the language reference. |
