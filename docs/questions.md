...
There is **no** separate interrogative pronoun. Unbound *who* / *what* / *where* / *when?* / *what did they do?* / *what happened?* use [unspecified-member **-r**](coordination.md#unspecified-member-r-phrase) in the queried slot.
...
| Question shape | Ask | Answer |
|----------------|------|--------|
| `zar` … `dar` | *Who … what?* | two fills, same order as the **-r**s |
| `zar` … `har` | *Who … when?* | entity then circumstance |
| `var` … `zar` | *Do what … who?* | VP fill then subject fill |
...
| Length | **…ar** | **…or** | **…er** | **…ur** |
|--------|---------|---------|---------|---------|
| **0** | *Who/what?* | *What (anything)?* / *Anything?* | *What’s the priority?* | *What else?* / *Who else?* |
...
| Form | Under question |
|------|----------------|
| **…em** (`zem` / `dem` / …) | *Is X the top priority?* / *Prefer X?* (offer) |
| **…el** (`zel` / `del` / …) | *Is X the only priority?* |
| **…oem** (`zoem` / …) | *Try X first?* / *Start with X?* (offer) |
| **…oel** (`zoel` / …) | *Only try X?* |
| **…uem** (`zuem` / …) | *X last?* / *Leave X for last?* (offer) |
| **…uel** (`zuel` / …) | *X last only?* |
...
| **…aol** | *Is X enough?* |
| **…aom** | *Would X do?* / *At least X?* (offer) |
...
| **…uol** | *Anything?* |
| **…uom** | *Anything?* |
| **…aol** | *All set?* / *Nothing else needed?* |
...
Fence morphology, nesting, and statement glosses: **[coordination.md](coordination.md)**.
