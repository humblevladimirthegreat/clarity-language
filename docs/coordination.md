...
- **Not general *but* / *however* / *therefore* / *meanwhile* / *next*:** those are other `/x/` linkers. *Including* / *rather* / *instead* / *except* (in-clause) and *Finally* / *in other words* / claim *instead* / *except* (before `/j/`) are [reviser](revisers.md), not clause joins. Phrase-, VP-, and clause-level **ranked** and **invert** (**zel** / **zael** / **zoel** / **zuel** / **zual** / **zuol** / **gel** / **vel** / **vael** / **voel** / **vuel** / **vual** / **vuol** / **xel** / **xuel** / …) **are** this series.
