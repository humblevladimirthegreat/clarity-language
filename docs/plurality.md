...
* **Quotation / fence markers** — Do not pluralize opens, atomics, anaphors, or closes (`*daxalsh`, `*daxansh`, `*daxarsh`, `*xuxulsh`); plural material *inside* a non-opaque span marks **-sh** on its own words.
