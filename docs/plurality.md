...
* **Word-level coordinators** ([**al** / **am** / **ol** / …](coordination.md)) — No **-sh** (closure **-l** / **-m** only). Plurality is marked on each conjunct independently (`z-dogl am z-catlsh`).
...
| bare **al** / **am** / **ol** / … | *(not used — closure ending only, no **-sh**)* |
