...
| G-H13 | warning (*watch out!*, *careful!*) | interjection `yawarun.` (*Warning!*) / `yulonen.` (*Danger!*) ([speech-moves#interjections](../grammar/speech-moves.md#interjections)); advice with protective warrant `yel zedonen vawalal thuhuhether.` ([values#interest-force](../grammar/interests.md#interest-force)); `yul yul` for danger | covered | speech-moves.md | — | — |
