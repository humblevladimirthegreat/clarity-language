...
| G-B11 | *still* (continuing state/action) | `/h/` STILL `hanogom` (`/w/` on one adjective); ending = permanence, **-l** not expected to change back / **-m** could change / **-r** only for now — [knowing#phasal](../grammar/knowing.md#phasal) | covered | knowing.md | — | — |
| G-B12 | *already* | `/h/` ALREADY `hahagam` (`/w/` on one adjective); ending = permanence, **-l** not expected to change back / **-m** could change / **-r** only for now — [knowing#phasal](../grammar/knowing.md#phasal) | covered | knowing.md | — | — |
| G-B13 | *not yet* | `/h/` NOT-YET `hezedem` (`/w/` on one adjective); ending = permanence, **-l** not expected to change back / **-m** could change / **-r** only for now — [knowing#phasal](../grammar/knowing.md#phasal) | covered | knowing.md | — | — |
| G-B14 | *anymore* / *no longer* | `/h/` NO-LONGER `huwulum` (`/w/` on one adjective); ending = permanence, **-l** not expected to change back / **-m** could change / **-r** only for now — [knowing#phasal](../grammar/knowing.md#phasal) | covered | knowing.md | — | — |
