...
**Caption:** later checkpoints use **`Roots used here:`** only. If the table has **Same root as**, use **`Roots used here` (Same root as is not the word you produce):** — that column is not the answer. Spell **English** / **Agalan** / **Same root as** / **Cue** only in [How to learn](../grammar/introduction.md#cues) and the first learner banks ([core.md](../grammar/core.md#translation-practice) Beginner, [reference-suffix.md](../grammar/reference-suffix.md#translation-practice) Beginner).
