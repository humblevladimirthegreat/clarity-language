...
Omit recoverable **`jal`** unless the drill is teaching force. Match orthography and sense endings to the grammar page ([core.md § Orthography](../grammar/core.md#orthography)).

## Related meta

| Page | Owns |
|------|------|
| [grammar-docs.md](grammar-docs.md) | Learner prose, teach order, worked examples |
| [learning-levels.md](learning-levels.md) | Beginner / Intermediate / Advanced bands and cross-doc path |
| [glosses.md](glosses.md) | Morph gloss and free English (for teaching lines, not required in spoilers) |
