...
e) **Coordination-particle exception:** Bare **a**, **e**, **o**, and **u** (and the sequences **a e** / **a o**, written **a/e** / **a/o**) are [word-level coordinators](coordination.md). They have **no** PoS prefix and **no** reference suffix. In Oxford-style lists they appear only **once**, immediately before the final conjunct (non-final conjuncts are juxtaposed). Boundaries stay clear because the previous word ends in a reference suffix (or **-sh**) and the next word begins with a PoS consonant. These bare vowels are reserved; they are not lexicon roots.
