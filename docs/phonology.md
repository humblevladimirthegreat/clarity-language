...
f) **Coordination and revision vowels:** [Phrase-level](coordination.md#phrase-level-coordination) (`/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/`: `zal`, `zam`, `zar`, `zor`, `zer`, `zur`, `gal`, `gam`, `ham`, …), [VP-level](coordination.md#vp-level-coordination) (`/v/`: `val`, `vam`, `var`, …), and [clause-level](coordination.md#clause-level-coordination) (`/x/`: `xal`, `xam`, `xar`, …) coordinators use the same vowel series under an ordinary PoS+root+ending shape; those vowel roots are reserved as joiners only (**-l** / **-m** / **-n** on **a** / **o** / **u** / **ao** / **e** / **ae** / **oe** / **ua** / **uo** / **ue** = closed / open / named at phrase level; soft **-n** at VP/clause; **-r** on **a** / **o** / **e** / **u** at all levels = [unspecified-member](coordination.md#unspecified-member-r-phrase) (*something* / *anything* / *whatever-by-rank* / *something else* — VP *do something*, clause *something happened*; bare **u** = [negation](coordination.md#negation-u)); **e** / **oe** = ranked — unmarked / exclusive; **ae** = equality / tie; leading **u** on **a** / **o** / **e** = [invert](coordination.md#invert-u-stacks) (*everything but* / *anything but* / **rank reversal**; no three-vowel stacks; empty-allowed on bare **o** + **-m** only) — not ordinary reference-suffix senses). All levels use a **fence** (optional shared modifiers immediately after the coordinator; juxtaposed conjuncts; **left** preferred, **right close** allowed for style/comedy; [fence nesting](coordination.md#fence-nesting); pure infix illegal). There are **no** bare (prefix-less) **coordinator** particles. Prefix-less **al** / **am** / **an** / **el** / **em** / **en** / **ol** / **om** / **on** / **ul** / **um** / **un** (**-l** / **-m** / named **-n** required; no **-r**; bare **a** / **e** / **o** / **u** illegal) are reserved as [in-clause revision](coordination.md#in-clause-revision-bare-a--e--o--u) (*including* / *rather* / *instead* / *except*; **-l** / **-m** = closed / open right-hand side; **-n** = named/conventional frame, phrase-style not soft; parallel chains on fixed A, mixed REV allowed).

g) **Quote / mention / aside onset (`xl-`):** After discourse prefix `/x/`, an **l** may sit before a **single** vowel + ending, forming onset **`xl-`**. That marks [span fences](quotations.md) (`xlal` exact quote open, `xlel` aside open, `xlol` mention open, `xlul` close, …). Legal **only** in that closed series — not a global `xl` cluster, not left-bound attachment, and **not** clause coordinators (`xal` / `xam` / …). No stacked vowels on these forms. Mid-word **l** here is **not** the word-final ending.