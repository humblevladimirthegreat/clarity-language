...
2. optional **left-bound marker** **l** (adjectives only — see below)
...
f) **Coordination and revision vowels:** [Phrase-level](coordination.md#phrase-level-coordination) (`/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/`: `zal`, `zam`, `zar`, `zor`, `zer`, `zur`, `gal`, `gam`, `ham`, …), [VP-level](coordination.md#vp-level-coordination) (`/v/`: `val`, `vam`, `var`, …), and [clause-level](coordination.md#clause-level-coordination) (`/x/`: `xal`, `xam`, `xar`, …) coordinators use the same vowel series under an ordinary PoS+root+ending shape; those vowel roots are reserved as joiners only (**-l** / **-m** / **-n** on **a** / **o** / **u** / **ao** / **e** / **ae** / **oe** / **uo** / **uao** / **ue** / **uae** / **uoe** = closed / open / named at phrase level; soft **-n** at VP/clause; **-r** on **a** / **o** / **e** / **u** at all levels = [unspecified-member](coordination.md#unspecified-member-r-phrase) (*something* / *anything* / *whatever-by-rank* / *something weird* — VP *do something*, clause *something happened*); **e** / **ae** / **oe** = ranked conjunction — exclusivity unmarked / co-satisfiable / exclusive; leading **u** on **o** / **ao** / **e** / **ae** / **oe** = [empty-allowed](coordination.md#empty-allowed-u-prefix) (*at most one* / *zero or more* / ranked with abstention / *else nothing*) — not ordinary reference-suffix senses). All levels use a **fence** (optional shared modifiers immediately after the coordinator; juxtaposed conjuncts; **left** preferred, **right close** allowed for style/comedy; [fence nesting](coordination.md#fence-nesting); pure infix illegal). There are **no** bare (prefix-less) **coordinator** particles. Prefix-less **al** / **am** / **an** / **el** / **em** / **en** / **ol** / **om** / **on** / **ul** / **um** / **un** (**-l** / **-m** / named **-n** required; no **-r**; bare **a** / **e** / **o** / **u** illegal) are reserved as [in-clause revision](coordination.md#in-clause-revision-bare-a--e--o--u) (*including* / *rather* / *instead* / *except*; **-l** / **-m** = closed / open right-hand side; **-n** = named/conventional frame, phrase-style not soft; parallel chains on fixed A, mixed REV allowed).
