...
e) **Coordination and revision vowels:** [Phrase-level](coordination.md#phrase-level-coordination) (`/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/`: `zal`, `zam`, `zar`, `zor`, `zer`, `zur`, `gal`, `gam`, `ham`, …), [VP-level](coordination.md#vp-level-coordination) (`/v/`: `val`, `vam`, `var`, …), and [clause-level](coordination.md#clause-level-coordination) (`/x/`: `xal`, `xam`, `xar`, …) coordinators use the same vowel series under an ordinary PoS+root+ending shape; those vowel roots are reserved as joiners only (**-l** / **-m** / **-n** on **a** / **o** / **u** / **ao** / **e** / **ae** / **oe** = closed / open / named at phrase level; phrase **-r** on **a** / **o** / **e** / **u** = [unspecified-member](coordination.md#unspecified-member-r-phrase) (*something* / *anything* / *whatever-by-rank* / *some objection*); soft **-n** and continue **-r** at VP/clause; **e** / **ae** / **oe** = ranked conjunction — exclusivity unmarked / co-satisfiable / exclusive — not ordinary reference-suffix senses). Phrase-level is a **fence** (optional shared modifiers immediately after the coordinator; juxtaposed conjuncts; **left** preferred, **right close** allowed for style/comedy). VP-level and clause-level are **left-open opener / `-r` continue** (opener first; `-r` before every non-initial conjunct). There are **no** bare (prefix-less) **coordinator** particles. Prefix-less **al** / **am** / **an** / **el** / **em** / **en** / **ol** / **om** / **on** / **ul** / **um** / **un** (**-l** / **-m** / named **-n** required; no **-r**; bare **a** / **e** / **o** / **u** illegal) are reserved as [in-clause revision](coordination.md#in-clause-revision-bare-a--e--o--u) (*including* / *rather* / *instead* / *except*; **-l** / **-m** = closed / open right-hand side; **-n** = named/conventional frame, phrase-style not soft; parallel chains on fixed A, mixed REV allowed).
