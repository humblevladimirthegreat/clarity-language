...
e) **Coordination-particle exception:** Bare **al**, **am**, **ol**, **om**, **ul**, **um**, **aol**, and **aom** are [word-level coordinators](coordination.md). They have **no** PoS prefix; the final **-l** / **-m** marks closed vs open (not ordinary literal/metaphorical reference). In Oxford-style lists they appear only **once**, immediately before the final conjunct (non-final conjuncts are juxtaposed). Boundaries stay clear because the previous word ends in a reference suffix (or **-sh**) and the next word begins with a PoS consonant. These forms are reserved; they are not lexicon roots.
