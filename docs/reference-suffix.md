...
* **Quote / aside / mention / opaque markers** — Closed span series ([quotations.md](quotations.md)): **open** `{PoS}{TYPE}x{EDGE}{ENDING}` (e.g. `daxal`); TYPE = **a** quote / **e** aside / **o** mention / **u** opaque; EDGE = **a** multi / **e** clause-scoped / **u** empty; escape = **`xoxol`** (EDGE **o** only on that fixed form); **-l** = exact; **-m** = paraphrase; **-n** = atomic (one token, no close); **-r** = [span anaphor](quotations.md#endings) (*that* quote / mention / … — ordinary pronoun, not a re-open). **Close** = **`xuxul`** (pop one) / **`xuxum`** (pop all) — not PoS/TYPE-matched; not clause-join soft **-n**. Named material *inside* quote / mention / aside still takes ordinary content-word **-n** (`z-Samn`, …). Opaque interiors are not parsed as Clarity.
...
| `/x/` | Titled / official discourse label — thread shift (*let’s now talk about X*; other roots). On [span](quotations.md) markers, **-l** / **-m** / **-n** / **-r** = exact / paraphrase / atomic / span anaphor; closes are **`xuxul`** / **`xuxum`**. On clause joins, **-n** is soft join packaging (*and then* **`xan`** / uncertain reconstruction / soft ranking); **-r** on **a** / **o** / **e** / **u** is unspecified-member (*something happened*, …) — see [coordination.md](coordination.md). Ordinary *but* / *however* stay **-l** / **-m**. Phrase- and VP-level joins: [coordination.md](coordination.md); VP `-n` = [join-act verbs](special-vocabulary.md#join-act-verbs) |
...
On [joins](coordination.md), the same letters are specialized again: phrase-level **zal** / **zam** / **zan** / **zar** / **zol** / **zom** / **zor** / **zul** / **zum** / **zun** / **zur** / **zel** / **zem** / **zen** / **zer** / **zael** / **zoel** / … / **gal** / **gam** / **gan** / **gel** / … (and `/w/` `/h/` forms) use **-l** / **-m** / **-n** for **closed** / **open** / **named** on every join vowel (**a** / **o** / **u** / **ao** / **e** / **ae** / **oe**; **e** / **ae** / **oe** = **rank joins** — unmarked / equality / exclusive (**e** unmarked order; **ae** tie/equality; **oe** exclusive)), plus **-r** on **a** / **o** / **e** / **u** for [unspecified-member](coordination.md#unspecified-member-r-phrase) (**zar** / **zor** / **zer** / **zur**, all arities). VP-level **val** / **vam** / **var** / **vul** / **vum** / **vel** / **vael** / **voel** / … (under `/v/`) use **-l** / **-m** for closed/open and **-r** on **a** / **o** / **e** / **u** for unspecified-member (*do something*, …); VP **-n** spellings (`van`, `von`, `vun`, …) are closed [join-act verbs](special-vocabulary.md#join-act-verbs), not soft joins. Clause **xal** / **xan** / **xar** / **xul** / **xum** / **xun** / **xel** / **xael** / **xoel** / **xen** / … use **-l** / **-m** for closed/open, **-n** for **soft** packaging (*and then* **`xan`** / uncertain reconstruction / soft ranking / soft denial; not the phrase named sense), and **-r** on **a** / **o** / **e** / **u** for the same unspecified-member series (*something happened*, …; under [question](questions.md) = fill-ask) — **not** list continue. All levels share a **fence** (left preferred; right close; [fence nesting](coordination.md#fence-nesting); pure infix illegal). There are no prefix-less joins. Prefix-less **al** / **am** / **an** / **el** / **em** / **en** / **ol** / **om** / **on** / **ul** / **um** / **un** (**-l** / **-m** / named **-n** required; no **-r**; bare **a** / **e** / **o** / **u** illegal) are [revisers](revisers.md): vowel = *including* / *rather* / *instead* / *except*; **-l** / **-m** = exhaustive vs open **right-hand side**; **-n** = named/conventional frame (phrase-style, not soft); chains `A REV₁ B REV₂ C` apply each **REV** in **parallel to A** (mixed vowels/endings allowed). Details live in coordination.md.
