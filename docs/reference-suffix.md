...
* **Linkers** (*but*, *however*, *therefore*) — Stay **-l** / **-m**; not names. Word-level *and* / *or* / *nor* / *except* / *instead* are bare particles with **-l** / **-m** / **-n** (named lists) — see [coordination.md](coordination.md).
* **Clause coordinators** (`xa` / `xo` / `xu` / `xao` / `xe` + ending) — Vowel = join type; on **a** / **o** / **u** / **ao**, **-l** / **-m** = closed vs open committed lists; on **e**, **-l** / **-m** = exception vs replacement (`xel` / `xem`); **-n** = soft packaging (*and then* / uncertain reconstruction; **not** word-level named-list **-n**; **not on `e`**); **-r** continues that list (required for flat 3+ chains; a second **-l**/**-m**/**-n** nests — e.g. `A xol B xol C` = *A or (B or C)*). Full table: [coordination.md](coordination.md#vowels--endings).
...
| `/x/` | Titled / official discourse label — thread shift (*let’s now talk about X*; other roots). On clause coordinators, **-n** is soft join packaging (*and then* / uncertain reconstruction; not on **e**) — see [coordination.md](coordination.md). Ordinary *but* / *however* stay **-l** / **-m**. Word-level coordinators: [coordination.md](coordination.md) |
...
On [coordinators](coordination.md), the same letters are specialized again: word-level **al** / **am** / **an** / **el** / **em** / … use **-l** / **-m** / **-n** for **closed** / **open** / **named** (on **a** / **o** / **u** / **ao**) or **exception** / **replacement** (on **e**; no word-level **-n**), while clause **xal** / **xan** / **xel** / … use **-l** / **-m** for closed/open or exception/replacement, **-n** for **soft** packaging (*and then* / uncertain reconstruction; not on **e**; not the word-level named sense), and **-r** to continue a clause list. Details live in coordination.md.
