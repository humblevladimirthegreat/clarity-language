...
* **Linkers** (*but*, *however*, *therefore*) — Stay **-l** / **-m**; not names. Word-level *and* / *or* / *nor* / *except* / *instead* are bare particles with **-l** / **-m** / **-n** (named lists); NP-level uses `/z/` `/d/` `/b/` + the same series (`zam`, `zan`, …); AP-level uses `/ɡ/` (`gam`, `gan`, …) — also Oxford named **-n** — see [coordination.md](coordination.md).
...
On [coordinators](coordination.md), the same letters are specialized again: Oxford word-level **al** / **am** / **an** / **el** / **em** / …, NP-level **zal** / **zam** / **zan** / **zel** / … (under `/z/` `/d/` `/b/`), and AP-level **gal** / **gam** / **gan** / **gel** / … (under `/ɡ/`) use **-l** / **-m** / **-n** for **closed** / **open** / **named** (on **a** / **o** / **u** / **ao**) or **exception** / **replacement** (on **e**; no Oxford **-n** on **e**; no **-r**), while clause **xal** / **xan** / **xel** / … use **-l** / **-m** for closed/open or exception/replacement, **-n** for **soft** packaging (*and then* / uncertain reconstruction; not on **e**; not the Oxford named sense), and **-r** to continue a clause list. Details live in coordination.md.
