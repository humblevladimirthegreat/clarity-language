...
* **Linkers** (*but*, *however*, *therefore*) — Stay **-l** / **-m**; not names. Phrase-level *and* / *or* / *nor* / *and/or* / ranked conjunction use `/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/` (`zam`, `zan`, `zar`, `zor`, `zer`, `zur`, `gam`, `gan`, `zel`, `zael`, `zoel`, `zen`, …) with named **-n** where allowed and **-r** on **a**/**o**/**e**/**u** for *something*/*anything*/*whatever-by-rank*/*something weird* (fence: left preferred, right close allowed; nesting per [fence nesting](coordination.md#fence-nesting)). VP-level uses `/v/` (`vam`, `van`, `var`, `vel`, `vael`, `voel`, …) with soft **-n** and unspecified-member **-r** (same fence) — see [coordination.md](coordination.md).
* **Clause coordinators** (`xa` / `xo` / `xu` / `xao` / `xe` / `xae` / `xoe` + ending) — Vowel = join type (**e** / **ae** / **oe** = ranked conjunction — unmarked / co-satisfiable / exclusive); **-l** / **-m** = closed vs open committed lists on every join vowel; **-n** = soft packaging (*and then* / uncertain reconstruction / soft ranking; **not** phrase named-list **-n**); **-r** on **a** / **o** / **e** / **u** = unspecified-member (*something happened* / *anything* / *whatever-by-rank* / *something weird*; under [question](questions.md) = fill-ask) — **not** list continue. Same **fence** as phrase and VP (left preferred; right close; nesting: left stack = right-assoc, right stack = left-assoc; pure infix illegal). Full table: [coordination.md](coordination.md#vp-clause-forms).
...
| `/x/` | Titled / official discourse label — thread shift (*let’s now talk about X*; other roots). On clause coordinators, **-n** is soft join packaging (*and then* / uncertain reconstruction / soft ranking); **-r** on **a**/**o**/**e**/**u** is unspecified-member (*something happened*, …) — see [coordination.md](coordination.md). Ordinary *but* / *however* stay **-l** / **-m**. Phrase- and VP-level coordinators: [coordination.md](coordination.md) |
...
On [coordinators](coordination.md), the same letters are specialized again: phrase-level **zal** / **zam** / **zan** / **zar** / **zol** / **zom** / **zor** / **zul** / **zum** / **zur** / **zel** / **zem** / **zen** / **zer** / **zael** / **zoel** / … / **gal** / **gam** / **gan** / **gel** / … (and `/w/` `/h/` forms) use **-l** / **-m** / **-n** for **closed** / **open** / **named** on every join vowel (**a** / **o** / **u** / **ao** / **e** / **ae** / **oe**; **e** / **ae** / **oe** = ranked conjunction — unmarked / co-satisfiable / exclusive), plus **-r** on **a** / **o** / **e** / **u** for [unspecified-member](coordination.md#unspecified-member-r-phrase) (**zar** / **zor** / **zer** / **zur**, all arities), while VP-level **val** / **vam** / **van** / **var** / **vel** / **vael** / **voel** / … (under `/v/`) and clause **xal** / **xan** / **xar** / **xel** / **xael** / **xoel** / **xen** / … use **-l** / **-m** for closed/open, **-n** for **soft** packaging (*and then* / uncertain reconstruction / soft ranking; not the phrase named sense), and **-r** on **a** / **o** / **e** / **u** for the same unspecified-member series (*do something* / *something happened*, …; under [question](questions.md) = fill-ask) — **not** list continue. All levels share a **fence** (left preferred; right close; [fence nesting](coordination.md#fence-nesting); pure infix illegal). There are no bare word-level coordinators. Prefix-less **al** / **am** / **an** / **el** / **em** / **en** / **ol** / **om** / **on** / **ul** / **um** / **un** (**-l** / **-m** / named **-n** required; no **-r**; bare **a** / **e** / **o** / **u** illegal) are [in-clause revision](coordination.md#in-clause-revision-bare-a--e--o--u): vowel = *including* / *rather* / *instead* / *except*; **-l** / **-m** = exhaustive vs open **right-hand side**; **-n** = named/conventional frame (phrase-style, not soft); chains `A REV₁ B REV₂ C` apply each **REV** in **parallel to A** (mixed vowels/endings allowed). Details live in coordination.md.
