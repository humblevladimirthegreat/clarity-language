...
* **Linkers** (*but*, *however*, *therefore*) — Stay **-l** / **-m**; not names. Phrase-level *and* / *or* / *nor* / *except* / *instead* use `/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/` (`zam`, `zan`, `gam`, `gan`, …) with named **-n** where allowed (left fence). VP-level uses `/v/` (`vam`, `van`, `var`, …) with soft **-n** and continue **-r** (like clauses) — see [coordination.md](coordination.md).
* **Clause coordinators** (`xa` / `xo` / `xu` / `xao` / `xe` + ending) — Vowel = join type; on **a** / **o** / **u** / **ao**, **-l** / **-m** = closed vs open committed lists; on **e**, **-l** / **-m** = exception vs replacement (`xel` / `xem`); **-n** = soft packaging (*and then* / uncertain reconstruction; **not** phrase named-list **-n**; **not on `e`**); **-r** continues that list (required before every non-initial conjunct; a second **-l**/**-m**/**-n** nests — e.g. `xol A xol B xor C` = *A or (B or C)*). Same left-open opener/`-r` pattern as [VP-level](coordination.md#vp-level-coordination). Full table: [coordination.md](coordination.md#opener-r-coordination).
...
On [coordinators](coordination.md), the same letters are specialized again: phrase-level **zal** / **zam** / **zan** / **zel** / … / **gal** / **gam** / **gan** / **gel** / … (and `/w/` `/h/` forms) use **-l** / **-m** / **-n** for **closed** / **open** / **named** (on **a** / **o** / **u** / **ao**) or **exception** / **replacement** (on **e**; no named **-n** on **e**; no **-r**), while VP-level **val** / **vam** / **van** / **var** / … (under `/v/`) and clause **xal** / **xan** / **xel** / … use **-l** / **-m** for closed/open or exception/replacement, **-n** for **soft** packaging (*and then* / uncertain reconstruction; not on **e**; not the phrase named sense), and **-r** to continue a list. There are no bare word-level coordinators. Details live in coordination.md.
