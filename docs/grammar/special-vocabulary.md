...
| *fireworks* | `urewol` | | |
| *hug* | `uhugul` | | |
| *stimulus* | `gobobum` | `obobul` *emphasis* | ☝️: you point at it rather than keep it |
| *tell* | `vezehel` | `ezehel` *speech* | 💬: saying it to someone |
| *HIGH* | `hogegam` | `ogegal` *ocean* | 🌊: water in surge |
