...
English *by*, *for*, *about*, and *as* each cover several jobs. Pick the Agalan job, then open the teaching section. This page is a lookup, not a lesson.
...
| English itch | Agalan job | Teach |
|--------------|------------|-------|
| recipient / addressee (*tells Ululon*) | unhosted `/b/` | [Extra nouns](core.md#extra-nouns) |
| need as reason (*walks for relatedness*) | values **`xo`** on `/h/` | [Motive](values.md#value-preference) |
| noun’s purpose (*a gift for relatedness*) | values **`xo`** on `/ɡ/` | [Motive](values.md#value-preference) |
...
| place (*walks about the house*) | locative (*inside* / *through*), not topic | [Locative relations](core.md#locative-relations) |
