...
**Prerequisites:** [design-methods.md](design-methods.md) (psychological purpose / limits); [introduction.md](introduction.md) (grammar design, how to learn). Word endings in full: [reference-suffix.md](reference-suffix.md). Pronouns (including **`odo`**): [pronouns.md](pronouns.md). This page uses **Beginner** / **Intermediate** / **Advanced** sections — finish Beginner here before Intermediate.
