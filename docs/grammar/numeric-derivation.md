...
**`+0`** treats ROOT as **resettable / emptied**; **`-0`** treats ROOT as **resisting emptying** (insistent residue). The role letter says *what kind of thing* is being emptied or refusing. **`ROOTl-e`** is *void of ROOT* (no such kind); **`ROOTl+0`** is a resettable instance of that kind.
...
- Lexical-compound join (**-l** / **-m**): [x-compounds.md](x-compounds.md#lexical-compounds)
