...
**Compare with:** *part of* / *contents of* / *made of* / origin *from* use [of relations](relations.md#of-relations), not `oboru`. A [values](values.md) need on `/ɡ/` already means the speaker’s belonging (`golozoxal` *my … serves competence*).
...
These limits apply to every join.
