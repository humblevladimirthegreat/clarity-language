...
Content questions (*who* / *what* / *where*) use phrase-level [unspecified-member **-r**](coordination.md#unspecified-member-r-phrase) (`zar` / `zor` / `zer` / `zur`, and unary / multi) in the queried slot (PoS prefix = role) under the same **polar question** force as yes/no questions; there is no separate interrogative pronoun. Nullary **-m** under polar force confirms open emptiness (*Got nothing?*), not the fill-ask.

## Phrase-level, VP-level, and clause-level coordination

There is **no** bare word-level **coordinator** series. **`/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/`** + the coordination vowels + ending (`zam`, `dol`, `bem`, `gam`, `wam`, `ham`, `zar`, `zor`, `zer`, `zur`, …) join same-slot phrases or single-word siblings with a **fence** (shared modifiers immediately after the coordinator — left preferred: `zam g-bigl z-dogl z-catl` = *big (dog and cat)*; right close allowed: `z-dogl z-catl zam g-bigl`). **`/v/`** and **`/x/`** use shared **left-open opener / `-r` continue** (`vam A var B`, `xal A xar B`, …). On VP chains, `/h/` before the opener scopes over all VPs; `/h/` inside a conjunct scopes that VP only. Phrase **-l**/**-m**/**-n** = closed/open/named on every join vowel (**a** / **o** / **u** / **ao** / **e** / **ae** / **oe**); phrase **-r** on **a**/**o**/**e**/**u** = [unspecified-member](coordination.md#unspecified-member-r-phrase) (`zar` / `zor` / `zer` / `zur` = *something* / *anything* / *whatever-by-rank* / *some objection*, all arities); **e** / **ae** / **oe** are **ranked conjunction** (earlier ≻ later; **ae** = co-satisfiable, **oe** = exclusive, bare **e** = exclusivity unmarked; preference vs fallback from context). Phrase unary / nullary: **…em** / **…el** / **…oem** / **…oel** / **…en** / **…al** / **…am** / **…an** / **…ol** / **…om** / **…aol** / **…aom** / **…ul** / **…um** / **…ar** / **…or** / **…er** / **…ur** (unary: *X first* / *only X matters* / *try X first* / *only try X* / *X first* (stock) / *just X* / *X, for one* / *has to be X* / *say, X* / *X’ll do* / *at least X* / *some (unknown) X* / *any X* / *X as a priority* / *some objection involving X*; nullary: *don’t care* / *nothing comes to mind* / *null* / *no options* / *I got no pick* / *all set* / *nothing I need* / *do nothing* / *no objections* / *something* / *anything* / …; **…an** = *null* / *void*, **…en** = *it’s a draw*, **…ar** = *something*, **…or** = *anything*, **…er** = *whatever-by-rank*, **…ur** = *some objection* — [coordination.md](coordination.md#unary-phrase); under polar question: **…ar** / **…or** / **…er** / **…ur** = content questions, unary **-m** offer, nullary **-m** confirm open emptiness, nullary **-l** colloquial emptiness check). Opener soft **-n** and continue **-r** replace named **-n**. Correlatives come later.
...
Phrase-level *and* / *or* / *nor* / *and/or* / ranked conjunction are **not** general `/x/` linkers — they use `/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/` + the coordination vowels + ending (`zam`, `gam`, `zar`, `zor`, `zer`, `zur`, `zel`, `zael`, `zoel`, …) with a **fence** (left preferred; right close allowed — [coordination.md](coordination.md)). VP-level uses `/v/` (`vam`, `var`, `vel`, `vael`, `voel`, …) — left-open opener / **-r**. Clause-level forms **are** `/x/` + the same vowels + ending (`xal`, `xel`, `xael`, `xoel`, …) — see [coordination.md](coordination.md#clause-level-coordination).
...
Phrase-level **zam** / **gam** / … (fence: left preferred, right close for style/comedy; shared modifiers immediately after the coordinator); [opener / `-r`](coordination.md#opener-r-coordination) for VP **vam** / **var** / … (left-open; `/h/` before opener = all VPs) and clause `/x/` + vowel + ending (soft **-n** ≠ named **-n**); prefix-less **al** / **am** / **an** / **el** / … (**-l** / **-m** / named **-n** required; parallel chains on fixed A) = in-clause revision (*including* / *rather* / *instead* / *except*): **[coordination.md](coordination.md)**. No bare word-level coordinators.
