...
There is **no** bare word-level **coordinator** series. **`/z/` `/d/` `/b/` `/ɡ/` `/w/` `/h/`** + the coordination vowels + ending (`zam`, `dol`, `bem`, `gam`, `wam`, `ham`, `zar`, `zor`, …) join same-slot phrases or single-word siblings with a **fence** (shared modifiers immediately after the coordinator — left preferred: `zam g-bigl z-dogl z-catl` = *big (dog and cat)*; right close allowed: `z-dogl z-catl zam g-bigl`). **`/v/`** and **`/x/`** use shared **left-open opener / `-r` continue** (`vam A var B`, `xal A xar B`, …). On VP chains, `/h/` before the opener scopes over all VPs; `/h/` inside a conjunct scopes that VP only. Phrase **-l**/**-m**/**-n** = closed/open/named on every join vowel (**a** / **o** / **u** / **ao** / **e** / **ae** / **oe**); phrase **-r** on **a**/**o** only = [*something* / *anything*](coordination.md#unspecified-member-r-phrase-a--o) (`zar` / `zor`, all arities); **e** / **ae** / **oe** are **ranked conjunction** (earlier ≻ later; **ae** = co-satisfiable, **oe** = exclusive, bare **e** = exclusivity unmarked; preference vs fallback from context). Phrase unary / nullary: **…em** / **…el** / **…oem** / **…oel** / **…en** / **…al** / **…am** / **…an** / **…ol** / **…om** / **…aol** / **…aom** / **…ul** / **…um** / **…ar** / **…or** (unary: *X first* / *only X matters* / *try X first* / *only try X* / *X first* (stock) / *just X* / *X, for one* / *has to be X* / *say, X* / *X’ll do* / *at least X* / *some (unknown) X* / *any X*; nullary: *don’t care* / *nothing comes to mind* / *null* / *no options* / *I got no pick* / *all set* / *nothing I need* / *do nothing* / *no objections* / *something* / *anything* / …; **…an** = *null* / *void*, **…en** = *it’s a draw*, **…ar** = *something*, **…or** = *anything* — [coordination.md](coordination.md#unary-phrase); under polar question: unary **-m** offer, nullary **-m** soft fill-ask, nullary **-l** colloquial emptiness check). Opener soft **-n** and continue **-r** replace named **-n**. Correlatives come later.
