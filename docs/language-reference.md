...
Verb (/v/) \- the action being done. [Ability / incapability](special-vocabulary.md#ability) compounds onto the verb root when that is the denied activity (`v<sing>xun` = can’t sing, fixed); hostless *can’t* uses floating **`h<ABIL>…`**.
