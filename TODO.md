...
- Correlatives: *both…and, either…or* (word-, NP-, and clause-level *and* / *or* / *nor* are in `docs/coordination.md`)
...
Update the `/x/` section as this fuller class lands. (Documented elsewhere, not `/x/`: word- and NP-level *and*/*or* = `docs/coordination.md`; topic = `/h/`+`/b/`; focus = word order; *if/because/although…* = `/h/`+`/b/` next-clause pronoun.)
