...
- Correlatives: *both…and, either…or* (word-, NP-, AP-, and clause-level *and* / *or* / *nor* are in `docs/coordination.md`)
...
Update the `/x/` section as this fuller class lands. (Documented elsewhere, not `/x/`: word-, NP-, and AP-level *and*/*or* = `docs/coordination.md`; topic = `/h/`+`/b/`; focus = word order; *if/because/although…* = `/h/`+`/b/` next-clause pronoun.)
