...
Design authority is **`docs/grammar/introduction.md`**, **`docs/grammar/core.md`**, and the other pages under **`docs/grammar/`** — not obsolete parsers. Learner banding and reading order live in `docs/meta/` (editors only).
